const config = {
  ...
  historicalSeasonalityOptions: [
    ...
    },
    {
      ...
      getLabel: (season) => `${season} Average Maximum Temperature`,
      value: "tmax",
      icon: "Temperature",
      type: "temperature",
      chartType: "Temperature",
    ...
    },
    {
      ...
      getLabel: (season) => `${season} Average Minimum Temperature`,
      value: "tmin",
      icon: "Temperature",
      type: "temperature",
      chartType: "Temperature",
  ...
  mapsSeasonalityOptions: [
    ...
    {
      label: "Medium Emissions Change in Precipitation",
      value: "change_seasonal_precip",
      type: "mappy_map",
    },
    {
      label: "High Emissions Change in Precipitation",
      value: "change_seasonal_precip",
      type: "mappy_map",
    },
    {
