...
export default function SandboxSumbitFigure(props) {
  ...
  const checkAuthorVerification = (key) => {
    ...
    const verifyAuthorURL =
      "https://v9bh75u4xh.execute-api.us-east-1.amazonaws.com/dev/verifyAuthor";

    // call to api to veify the author key
    axios
      .post(verifyAuthorURL, requestData, axiosConfig)
      .then((response) => {
        // get reponse if author is verified to send messages
