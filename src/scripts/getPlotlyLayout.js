...
export const getPlotlyLayout = (options) => {
  ...
  return {
    ...
    margin: {
      ...
      t: window.innerWidth <= smallScreenWidth ? 130 : 170,
...
export const getPredictedDataLayout = (options) => {
  ...
  return {
    ...
    legend: {
      ...
      bgcolor: colors.overlay.white80,
    ...
    yaxis: {
      ...
      linecolor: zeroLineColor,
      linewidth: zerolinewidth,
      zerolinecolor: colors.referenceLine,
      zerolinewidth: "5.0",
      bargap: bargap,
    },
    template: {
    ...
    annotations: [
      // Very High Emissions label
      {
        ...
        showarrow: false,
        textangle: -90,
        font: { color: colors.bracket.ssp585, size: 18, family: "Arial" },
        align: "left",
      ...
      // Intermediate Emissions label
      {
        ...
        showarrow: false,
        textangle: -90,
        font: { color: colors.bracket.ssp245, size: 18, family: "Arial" },
        align: "left",
      ...
      // High Emissions label
      {
        ...
        showarrow: false,
        textangle: -90,
        font: { color: colors.bracket.ssp370, size: 18, family: "Arial" },
        align: "left",
      ...
      // Low Emissions label
      {
        ...
        showarrow: false,
        textangle: -90,
        font: { color: colors.bracket.ssp126, size: 18, family: "Arial" },
        align: "left",
    ...
    shapes: [
      // Higher Emissions bracket
      {
        ...
        x1: 1.0085,
        y1: yHigherBottom,
        line: { color: colors.bracket.ssp585, width: 5 },
        meta: { scenario: "SSP5-8.5" },
      },
      {
        type: "line",
      ...
      // Intermediate Emissions bracket
      {
        ...
        line: { color: colors.bracket.ssp245, width: 5 },
        meta: { scenario: "SSP2-4.5" },
      },
      {
        type: "line",
      ...
      // High Emissions bracket (SSP3-7.0)
      {
        ...
        x1: 1.0285,
        y1: y370Bottom,
        line: { color: colors.bracket.ssp370, width: 5 },
        meta: { scenario: "SSP3-7.0" },
      },
      {
        type: "line",
      ...
      // Low Emissions bracket (SSP1-2.6)
      {
        ...
        x1: 1.0385,
        y1: yLowerBottom,
        line: { color: colors.bracket.ssp126, width: 5 },
        meta: { scenario: "SSP1-2.6" },
      },
      {
        type: "line",
